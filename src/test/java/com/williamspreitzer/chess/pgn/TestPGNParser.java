...
import com.williamspreitzer.chess.pgn.PGNPersistence;
import com.williamspreitzer.chess.pgn.PGNUtilities;
import com.williamspreitzer.chess.pgn.ParsePGNException;
...
public class TestPGNParser {
    ...
    public void testMax() throws IOException {
        int maxId = PGNPersistence.getMaxGameRow(conn);
    ...
    public void testWithErol() throws IOException {
        ...
        final Move move = PGNPersistence.queryBestMove(board, board.getCurrentPlayer(), "", conn);
        final MoveTransition moveTransition = board.getCurrentPlayer().makeMove(move);
        final Move move2 = PGNPersistence.queryBestMove(moveTransition.getBoard(),
