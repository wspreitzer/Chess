...
public class KnightTest {
	...
	public void testKnightsInHomeCorners() {
		Knight queensKnight = (Knight) PieceFactory.createPiece(PieceType.KNIGHT, GameUtils.getCoordinateAtPosition("a1"), Color.WHITE, false);
		Knight kingsKnight = (Knight) PieceFactory.createPiece(PieceType.KNIGHT, GameUtils.getCoordinateAtPosition("h1"), Color.WHITE, false);
	...
	public void testKnightsInOpponentCorners() {
		Knight queensKnight = (Knight) PieceFactory.createPiece(PieceType.KNIGHT, GameUtils.getCoordinateAtPosition("a8"), Color.WHITE, false);
		Knight kingsKnight = (Knight) PieceFactory.createPiece(PieceType.KNIGHT, GameUtils.getCoordinateAtPosition("h8"), Color.WHITE, false);
		builder.setPiece(kingsKnight);
		builder.setPiece(queensKnight);
		board = builder.build();
	...
	public void testKnightInMiddleOfBoard() {
		Knight knight = (Knight) PieceFactory.createPiece(PieceType.KNIGHT, GameUtils.getCoordinateAtPosition("d4"), Color.WHITE, false);
